<!--TITLE: Check Valid List Index Command -->
<!-- SUBTITLE: a command in the List group. -->
[Go To Automation Commands Overview](/automation-commands.md)


List &gt; List Index &gt; Check Valid List Index


# Check Valid List Index Command


## What does this command do?
This command allows you to Check Valid List Index.


## When would I want to use this command?
Use this command when you want to Check Valid List Index.
