<!--TITLE: Convert List To Text Command -->
<!-- SUBTITLE: a command in the List group. -->
[Go To Automation Commands Overview](/automation-commands.md)


List &gt; Convert &gt; Convert List To Text


# Convert List To Text Command


## What does this command do?
This command allows you to Convert List to Text.


## When would I want to use this command?
Use this command when you want to Convert List to Text.
...
Automation Class Name: ConvertListToTextCommand
