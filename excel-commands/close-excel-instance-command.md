<!--TITLE: Close Excel Instance Command -->
<!-- SUBTITLE: a command in the Excel group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Excel &gt; Instance &gt; Close Excel Instance
...
- [[6000,0x00001770] Optional - Please Select the If the Workbook should be Saved](#param_1)
...
<a id="param_1"></a>
### [6000,0x00001770] Optional - Please Select the If the Workbook should be Saved
