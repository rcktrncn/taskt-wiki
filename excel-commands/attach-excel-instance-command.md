<!--TITLE: Attach Excel Instance Command -->
<!-- SUBTITLE: a command in the Excel group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Excel &gt; Instance &gt; Attach Excel Instance


# Attach Excel Instance Command


## What does this command do?
This command Attach the Excel Instance.


## When would I want to use this command?
Use this command when you want to Attach an Existing Excelas Excel Instance.
