...
# Loop For List Command


## What does this command do?
This command allows you to Repeat actions on the values held by List. This command must have a following 'End Loop' command.
