<!--TITLE: Loop For DataTable Command -->
<!-- SUBTITLE: a command in the Loop group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Loop &gt; Loop For DataTable


# Loop For DataTable Command
...
<dt>Sample Usage</dt><dd><strong>Row First</strong> or  <strong>Column First</strong></dd>
<dt>Remarks</dt><dd><strong>Optional</strong><br>Default Value is <strong>Row First</strong></dd>
</dl>
