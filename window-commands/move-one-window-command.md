<!--TITLE: Move One Window Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; One Window Name Actions &gt; Move One Window


# Move One Window Command


## What does this command do?
This command Move one Window.


## When would I want to use this command?
Use this command when you want to Move one Window.
...
- [Optional - Please Select the When Window Is Maximized](#param_12)
...
Automation Class Name: MoveOneWindowCommand
