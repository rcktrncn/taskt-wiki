<!--TITLE: Activate Windows Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Multi Window Actions &gt; Activate Windows


# Activate Windows Command
...
Use this command when you want to active a windows by name
...
Automation Class Name: ActivateWindowsCommand
