<!--TITLE: Move Windows Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Multi Window Actions &gt; Move Windows


# Move Windows Command


## What does this command do?
This command Move windows.


## When would I want to use this command?
Use this command when you want to Move Windows
...
- [[9001,0x00002329] Optional - Please Select the When Window Is Maximized](#param_8)
- [[10000,0x00002710] Optional - Please Specify the Wait Time between Finding the Window and Executing Action (sec)](#param_9)
...
Automation Class Name: MoveWindowsCommand
