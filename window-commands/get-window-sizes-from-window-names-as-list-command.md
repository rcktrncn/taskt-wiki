<!--TITLE: Get Window Sizes From Window Names As List Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Get From Window Name &gt; Get Window Sizes From Window Names As List


# Get Window Sizes From Window Names As List Command
