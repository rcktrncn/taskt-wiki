<!--TITLE: Get Process Names From Window Names As DataTable Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Get From Window Name &gt; Get Process Names From Window Names As DataTable


# Get Process Names From Window Names As DataTable Command
...
Use this command when you want to get window process names.
...
<dt>Remarks</dt><dd>Column Names are <strong>WindowName</strong>, <strong>WindowHandle</strong>, and <strong>ProcessName</strong></dd>
</dl>
...
Automation Class Name: GetProcessNamesFromWindowNamesAsDataTableCommand
