<!--TITLE: Get One Window Handle From One Window Name Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Get From Window Name &gt; Get One Window Handle From One Window Name


# Get One Window Handle From One Window Name Command


## What does this command do?
This command returns one window handle.


## When would I want to use this command?
Use this command when you want to get one window handle.
...
- [[6500,0x00001964] Optional - Please Select the Variable Name to Store Window Handle Result](#param_2)
...
<a id="param_2"></a>
### [6500,0x00001964] Optional - Please Select the Variable Name to Store Window Handle Result
