<!--TITLE: Get One Window State Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Get From Window Name &gt; Get One Window State


# Get One Window State Command


## What does this command do?
This command returns one window state.


## When would I want to use this command?
Use this command when you want one window state.
