<!--TITLE: Get One Window Size Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Get From Window Name &gt; Get One Window Size


# Get One Window Size Command


## What does this command do?
This command returns one window size.


## When would I want to use this command?
Use this command when you want one window size.
...
- [Optional - Please Select the Variable Name to Recieve the Window Width](#param_2)
- [Optional - Please Select the Variable Name to Recieve the Window Height](#param_3)
...
- [Optional - Please Select the Case Sensitive Checking for Window Names](#param_9)
- [Optional - Please Select the Trim before Check Window Names](#param_10)
- [Optional - Please Select the When Window Is Minimized](#param_11)
...
Automation Class Name: GetOneWindowSizeCommand
