<!--TITLE: Get One Process Name From One Window Name Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Get From Window Name &gt; Get One Process Name From One Window Name


# Get One Process Name From One Window Name Command


## What does this command do?
This command returns one window process name.


## When would I want to use this command?
Use this command when you want to get one window process name.
...
Automation Class Name: GetOneProcessNameFromOneWindowNameCommand
