<!--TITLE: Get Window States From Window Names As DataTable Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Get From Window Name &gt; Get Window States From Window Names As DataTable


# Get Window States From Window Names As DataTable Command


## What does this command do?
This command returns window process states.


## When would I want to use this command?
Use this command when you want to get window states.
...
<dt>Remarks</dt><dd>Column Names are <strong>WindowName</strong>, <strong>WindowHandle</strong>, <strong>State</strong>, and <strong>StateText</strong></dd>
</dl>
...
Automation Class Name: GetWindowStatesFromWindowNamesAsDataTableCommand
