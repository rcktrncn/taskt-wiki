<!--TITLE: Get Window States From Window States As List Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Get From Window Name &gt; Get Window States From Window States As List


# Get Window States From Window States As List Command
...
<dt>Remarks</dt><dd>Restore is <strong>1</strong>, Minimize is <strong>2</strong>, Maximize is <strong>3</strong><br><br>
...
Automation Class Name: GetWindowStatesFromWindowNamesAsListCommand
