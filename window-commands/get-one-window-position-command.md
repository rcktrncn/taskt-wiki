<!--TITLE: Get One Window Position Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Get From Window Name &gt; Get One Window Position


# Get One Window Position Command


## What does this command do?
This command returns one window position.


## When would I want to use this command?
Use this command when you want one window position.
...
- [Optional - Please Select the Case Sensitive Checking for Window Names](#param_10)
- [Optional - Please Select the Trim before Check Window Names](#param_11)
- [Optional - Please Select the When Window Is Minimized](#param_12)
- [Optional - Please Select the When Window Is Maximized](#param_13)
