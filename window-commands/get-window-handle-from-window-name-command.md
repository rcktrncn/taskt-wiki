<!--TITLE: Get Window Handle From Window Name Command -->
<!-- SUBTITLE: a command in the Window Commands group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window Commands &gt; Window Actions &gt; Get Window Handle From Window Name


# Get Window Handle From Window Name Command


## What does this command do?
This command allows you to Get Window Handle from Window Name.


## When would I want to use this command?
Use this command when you want to Get Window Handle from Window Name.
