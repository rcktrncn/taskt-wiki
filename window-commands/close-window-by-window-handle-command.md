...
- [[10000,0x00002710] Optional - Please Specify the Wait Time between Finding the Window and Executing Action (sec)](#param_2)
- [[10000,0x00002710] Optional - Please Select the Variable Name to Store Window Name](#param_3)
- [[10010,0x0000271A] Optional - Please Select the Activate Window Before Action](#param_4)
