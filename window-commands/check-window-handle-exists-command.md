<!--TITLE: Check Window Handle Exists Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Get From Window Handle &gt; Check Window Handle Exists


# Check Window Handle Exists Command


## What does this command do?
This command returns a existence of Window Handle.


## When would I want to use this command?
Use this command when you want to check a existence of Window Handle.


<a id="param_list"></a>
## Command Parameters
- [[5000,0x00001388] Please Select the Window Handle Variable Name](#param_0)
- [[5500,0x0000157C] Please Select the Variable Name to Store Result](#param_1)
...
<a id="param_1"></a>
### [5500,0x0000157C] Please Select the Variable Name to Store Result
...
Automation Class Name: CheckWindowHandleExistsCommand
