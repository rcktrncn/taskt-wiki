<!--TITLE: Get Window Sizes From Window Names As DataTable Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Get From Window Name &gt; Get Window Sizes From Window Names As DataTable


# Get Window Sizes From Window Names As DataTable Command
...
Use this command when you want to get window sizes.
...
- [[9000,0x00002328] Optional - Please Select the When Window Is Minimized](#param_6)
...
<dt>Remarks</dt><dd>Column Names are <strong>WindowName</strong>, <strong>WindowHandle</strong>, <strong>Width</strong>, and <strong>Height</strong></dd>
</dl>
