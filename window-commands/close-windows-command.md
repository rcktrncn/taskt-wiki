<!--TITLE: Close Windows Command -->
<!-- SUBTITLE: a command in the Window group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Window &gt; Multi Window Actions &gt; Close Windows
...
This command closes windows.


## When would I want to use this command?
Use this command when you want to close an existing windows by name.
