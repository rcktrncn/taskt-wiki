<!--TITLE: Get Text Last Index Of Command -->
<!-- SUBTITLE: a command in the Text group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Text &gt; Check/Get &gt; Get Text Last Index Of


# Get Text Last Index Of Command


## What does this command do?
This command allows you to the Last Position of the Specified Text


## When would I want to use this command?
Use this command when you want to the Last Position of the Specified Text
...
- [[5000,0x00001388] Optional - Please Specify the Search Start Position](#param_4)
...
<a id="param_4"></a>
### [5000,0x00001388] Optional - Please Specify the Search Start Position
...
Automation Class Name: GetTextLastIndexOfCommand
