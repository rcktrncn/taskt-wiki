<!--TITLE: Calculate DateTime From Excel Serial Command -->
<!-- SUBTITLE: a command in the DateTime group. -->
[Go To Automation Commands Overview](/automation-commands.md)


DateTime &gt; Calculate &gt; Calculate DateTime From Excel Serial


# Calculate DateTime From Excel Serial Command


## What does this command do?
This command allows you to Calculate DateTime From Excel Serial. Add Day, Minute, etc.


## When would I want to use this command?
Use this command when you want to Calculate DateTime From Excel Serial. Add Day, Minute, etc.
...
- [[7000,0x00001B58] Please Select the Variable Name to Store Result](#param_3)
