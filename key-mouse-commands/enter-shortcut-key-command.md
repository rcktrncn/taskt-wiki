...
- [Optional - Please Specify the Wait Time for After Keys Enter](#param_6)
- [Optional - Please Select the Try Activate Window, when Specified Current Window Variable](#param_7)
...
- [Optional - Please Specify the Wait Time between Finding the Window and Executing Action (sec)](#param_12)
- [Optional - Please Select the Activate Window Before Action](#param_13)
