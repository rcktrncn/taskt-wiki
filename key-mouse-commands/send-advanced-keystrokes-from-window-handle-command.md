<!--TITLE: Send Advanced Keystrokes From Window Handle Command -->
<!-- SUBTITLE: a command in the Key/Mouse group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Key/Mouse &gt; Key &gt; Send Advanced Keystrokes From Window Handle


# Send Advanced Keystrokes From Window Handle Command
...
- [[8010,0x00001F4A] Optional - Please Specify the Wait Time for After Keys Enter](#param_4)
- [[8020,0x00001F54] Optional - Please Select the Try Activate Window, when Specified Current Window Variable](#param_5)
...
Automation Class Name: SendAdvancedKeyStrokesFromWindowHandleCommand
