...
<a id="param_list"></a>
## Command Parameters
- [[5000,0x00001388] Please Specify the Amount of Time to Pause for (in milliseconds)](#param_0)
- [[2147483647,0x7FFFFFFF] Optional - Please Specify the Comment Field](#param_1)


<a id="param_0"></a>
### [5000,0x00001388] Please Specify the Amount of Time to Pause for (in milliseconds)
