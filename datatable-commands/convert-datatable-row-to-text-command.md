<!--TITLE: Convert DataTable Row To Text Command -->
<!-- SUBTITLE: a command in the DataTable group. -->
[Go To Automation Commands Overview](/automation-commands.md)


DataTable &gt; Convert Row &gt; Convert DataTable Row To Text


# Convert DataTable Row To Text Command


## What does this command do?
This command allows you to convert DataTable Row to Text.


## When would I want to use this command?
Use this command when you want to convert DataTable Row to Text.
...
Automation Class Name: ConvertDataTableRowToTextCommand
