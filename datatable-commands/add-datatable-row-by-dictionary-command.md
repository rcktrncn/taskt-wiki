...
DataTable &gt; Row Action &gt; Add DataTable Row By Dictionary
...
- [[6000,0x00001770] Please Select the Dictionary Variable Name to add to the DataTable](#param_1)
- [[7000,0x00001B58] Optional - Please Select the When Dictionary Key does not Exists](#param_2)
...
<a id="param_1"></a>
### [6000,0x00001770] Please Select the Dictionary Variable Name to add to the DataTable
...
<a id="param_2"></a>
### [7000,0x00001B58] Optional - Please Select the When Dictionary Key does not Exists
