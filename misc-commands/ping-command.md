...
<a id="param_list"></a>
## Command Parameters
- [[5000,0x00001388] Please Specify the IP Address or Host Name that you want to ping (ex. 192.168.0.1, {vHost})](#param_0)
...
<a id="param_0"></a>
### [5000,0x00001388] Please Specify the IP Address or Host Name that you want to ping (ex. 192.168.0.1, {vHost})
