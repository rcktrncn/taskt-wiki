<!--TITLE: Covnert Dictionary To Visualized Text Command -->
<!-- SUBTITLE: a command in the Dictionary group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Dictionary &gt; Convert &gt; Covnert Dictionary To Visualized Text


# Covnert Dictionary To Visualized Text Command


## What does this command do?
This command allows you to Covnert Dictionary to Visualized Text.


## When would I want to use this command?
Use this command when you want to Covnert Dictionary to Visualized Text.


<a id="param_list"></a>
## Command Parameters
- [[5000,0x00001388] Please Select the Dictionary Variable Name](#param_0)
- [[7000,0x00001B58] Please Select the Variable Name to Store Result](#param_1)
...
Automation Class Name: ConvertDictionaryToVisualizedTextCommand
