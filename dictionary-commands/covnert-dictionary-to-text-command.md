<!--TITLE: Covnert Dictionary To Text Command -->
<!-- SUBTITLE: a command in the Dictionary group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Dictionary &gt; Convert &gt; Covnert Dictionary To Text


# Covnert Dictionary To Text Command


## What does this command do?
This command allows you to Covnert Dictionary to Text.


## When would I want to use this command?
Use this command when you want to Covnert Dictionary to Text.
...
Automation Class Name: ConvertDictionaryToTextCommand
