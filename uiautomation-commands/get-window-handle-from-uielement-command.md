<!--TITLE: Get Window Handle From UIElement Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Get From UIElement &gt; Get Window Handle From UIElement


# Get Window Handle From UIElement Command


## What does this command do?
This command allows you to get Window Handle from UIElement.
...
- [Please Select the Variable Name to Store Window Handle Result](#param_1)
...
Automation Class Name: UIAutomationGetWindowHandleFromUIElementCommand
