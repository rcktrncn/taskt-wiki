<!--TITLE: Search UIElement From Window Handle By XPath Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Search UIElement From Window &gt; Search UIElement From Window Handle By XPath


# Search UIElement From Window Handle By XPath Command


## What does this command do?
This command allows you to get UIElement from Window Handle using by XPath.
...
- [Optional - Please Select the Variable Name to Store Window UIElement](#param_9)
...
Automation Class Name: UIAutomationSearchUIElementFromWindowHandleByXPathCommand
