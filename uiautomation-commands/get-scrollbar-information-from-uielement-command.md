<!--TITLE: Get ScrollBar Information From UIElement Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Get From UIElement &gt; Get ScrollBar Information From UIElement


# Get ScrollBar Information From UIElement Command


## What does this command do?
This command allows you to get ScrollBar Information from UIElement.
...
<dt>Sample Usage</dt><dd><strong>Horizontally Scrollable</strong> or  <strong>Horizontal Scroll Percent</strong> or  <strong>Vertically Scrollable</strong> or  <strong>Vertical Scroll Percent</strong></dd>
<dt>Remarks</dt><dd>(nothing)</dd>
</dl>
...
Automation Class Name: UIAutomationGetScrollBarInformationFromUIElementCommand
