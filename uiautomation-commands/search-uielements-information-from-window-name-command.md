<!--TITLE: Search UIElements Information From Window Name Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Search UIElement From Window &gt; Search UIElements Information From Window Name


# Search UIElements Information From Window Name Command


## What does this command do?
This command allows you to get UIElements Information from Window Name.
...
- [Optional - Please Select the Check Method for the Window Name](#param_8)
- [Optional - Please Selection Method for the Window Name](#param_9)
- [Optional - Please Specify the Window Index](#param_10)
- [Optional - Please Specify the Wait Time for the Window to Exist (sec)](#param_11)
- [Optional - Please Select the Variable Name to Store Window Name Result](#param_12)
- [Optional - Please Select the Variable Name to Store Window Handle Result](#param_13)
...
Automation Class Name: UIAutomationSearchUIElementsInformationFromWindowNameCommand
