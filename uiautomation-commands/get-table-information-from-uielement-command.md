<!--TITLE: Get Table Information From UIElement Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Get From UIElement &gt; Get Table Information From UIElement


# Get Table Information From UIElement Command


## What does this command do?
This command allows you to get Table Information from UIElement.
...
- [Optional - Please Select the Contains Header Row, Column](#param_3)
...
<dt>Sample Usage</dt><dd><strong>Column Count</strong> or  <strong>Row Count</strong></dd>
<dt>Remarks</dt><dd>(nothing)</dd>
</dl>
...
<a id="param_3"></a>
### Optional - Please Select the Contains Header Row, Column
...
Automation Class Name: UIAutomationGetTableInformationFromUIElementCommand
