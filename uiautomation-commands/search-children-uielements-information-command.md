<!--TITLE: Search Children UIElements Information Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Search UIElement &gt; Search Children UIElements Information


# Search Children UIElements Information Command
...
- [Optional - Please Specify the Maxinum Number of UIElements to Search](#param_5)
- [Optional - Please Select the Search Siblings Direction](#param_6)
...
Automation Class Name: UIAutomationSearchChildrenUIElementsInformationCommand
