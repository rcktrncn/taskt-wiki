<!--TITLE: Select UIElement Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; UIElement Action &gt; Select UIElement


# Select UIElement Command


## What does this command do?
This command allows you to Select UIElement.
...
- [Optional - Please Select the Activate Window before Action](#param_1)
- [Optional - Please Specify the Wait Time before Action (sec)](#param_2)
- [Optional - Please Specify the Wait Time after Action (sec)](#param_3)
...
- [Optional - Please Select the When Action Is Not Supported](#param_6)
...
Automation Class Name: UIAutomationSelectUIElementCommand
