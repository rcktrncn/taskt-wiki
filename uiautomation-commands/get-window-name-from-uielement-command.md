<!--TITLE: Get Window Name From UIElement Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Get From UIElement &gt; Get Window Name From UIElement


# Get Window Name From UIElement Command


## What does this command do?
This command allows you to get Window Name from UIElement.
...
- [Please Select the Variable Name to Store Window Name Result](#param_1)
- [Optional - Please Select the When the Value(s) can not Retrieved](#param_2)
- [Optional - Please Select the Variable Name to Store Window Handle Result](#param_3)
...
<a id="param_1"></a>
### Please Select the Variable Name to Store Window Name Result
...
Automation Class Name: UIAutomationGetWindowNameFromUIElementCommand
