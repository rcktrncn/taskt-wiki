<!--TITLE: Set Selection State To UIElement Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; UIElement Action &gt; Set Selection State To UIElement


# Set Selection State To UIElement Command


## What does this command do?
This command allows you to set Selection State from UIElement.
...
- [Please Selection State](#param_1)
- [Optional - Please Select the Activate Window before Action](#param_2)
- [Optional - Please Specify the Wait Time before Action (sec)](#param_3)
- [Optional - Please Specify the Wait Time after Action (sec)](#param_4)
...
- [Optional - Please Select the When Action Is Not Supported](#param_7)
...
<dt>Parameter Direction</dt><dd>The Input Parameter for Executing the command</dd>
<dt>Sample Usage</dt><dd><strong>Selected</strong> or  <strong>Unselected</strong></dd>
<dt>Remarks</dt><dd>(nothing)</dd>
</dl>
...
Automation Class Name: UIAutomationSetSelectionStateToUIElementCommand
