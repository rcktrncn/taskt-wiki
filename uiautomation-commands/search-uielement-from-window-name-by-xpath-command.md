<!--TITLE: Search UIElement From Window Name By XPath Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Search UIElement From Window &gt; Search UIElement From Window Name By XPath


# Search UIElement From Window Name By XPath Command
...
- [Optional - Please Select the Check Method for the Window Name](#param_6)
- [Optional - Please Selection Method for the Window Name](#param_7)
- [Optional - Please Specify the Window Index](#param_8)
- [Optional - Please Specify the Wait Time for the Window to Exist (sec)](#param_9)
...
- [Optional - Please Select the Variable Name to Store Window UIElement](#param_12)
- [Optional - Please Select the Case Sensitive Checking for Window Names](#param_13)
- [Optional - Please Select the Trim before Check Window Names](#param_14)
...
Automation Class Name: UIAutomationSearchUIElementFromWindowNameByXPathCommand
