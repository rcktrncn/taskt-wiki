<!--TITLE: Search Child UIElement From UIElement By XPath Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Search UIElement By XPath &gt; Search Child UIElement From UIElement By XPath


# Search Child UIElement From UIElement By XPath Command


## What does this command do?
This command allows you to get Child UIElement from UIElement using by XPath.
...
Automation Class Name: UIAutomationSearchChildUIElementFromUIElementByXPathCommand
