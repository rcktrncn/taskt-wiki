<!--TITLE: Search UIElements Tree XML From Window Name Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Search UIElement From Window &gt; Search UIElements Tree XML From Window Name


# Search UIElements Tree XML From Window Name Command


## What does this command do?
This command allows you to Search UIElements Tree XML from Window Name.
...
- [Please Select the Variable Name to store XML](#param_2)
...
Automation Class Name: UIAutomationSearchUIElementsTreeXMLFromWindowNameCommand
