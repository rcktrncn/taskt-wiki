<!--TITLE: Get Property Value From UIElement Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Get From UIElement &gt; Get Property Value From UIElement


# Get Property Value From UIElement Command


## What does this command do?
This command allows you to get Property Value from UIElement.
...
- [Please Select the Property Name](#param_1)
- [Please Select the Variable Name to Store Result](#param_2)
- [Optional - Please Select the When the Value(s) can not Retrieved](#param_3)
...
<a id="param_1"></a>
### Please Select the Property Name
...
<dt>Sample Usage</dt><dd><strong>Name</strong> or  <strong>ControlType</strong> or  <strong>LocalizedControlType</strong> or  <strong>IsEnabled</strong> or  <strong>IsOffscreen</strong> or  <strong>IsKeyboardFocusable</strong> or  <strong>HasKeyboardFocusable</strong> or  <strong>AccessKey</strong> or  <strong>ProcessId</strong> or  <strong>AutomationId</strong> or  <strong>FrameworkId</strong> or  <strong>ClassName</strong> or  <strong>IsContentElement</strong> or  <strong>IsPassword</strong> or  <strong>AcceleratorKey</strong> or  <strong>HelpText</strong> or  <strong>IsControlElement</strong> or  <strong>IsRequiredForForm</strong> or  <strong>ItemStatus</strong> or  <strong>ItemType</strong> or  <strong>NativeWindowHandle</strong></dd>
<dt>Remarks</dt><dd>(nothing)</dd>
</dl>
...
<dt>Remarks</dt><dd><strong>Optional</strong><br>Default Value is <strong>Set Empty</strong></dd>
</dl>
...
Automation Class Name: UIAutomationGetPropertyValueFromUIElementCommand
