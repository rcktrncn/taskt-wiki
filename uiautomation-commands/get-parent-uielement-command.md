<!--TITLE: Get Parent UIElement Command -->
<!-- SUBTITLE: a command in the UIAutomation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation &gt; Get From UIElement &gt; Get Parent UIElement


# Get Parent UIElement Command


## What does this command do?
This command allows you to get Parent UIElement from UIElement.
...
- [Please Select the Variable Name to Store Parent UIElement](#param_1)
...
<a id="param_1"></a>
### Please Select the Variable Name to Store Parent UIElement
...
Automation Class Name: UIAutomationGetParentUIElementCommand
