<!--TITLE: Compare Number Command -->
<!-- SUBTITLE: a command in the Numerical group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Numerical &gt; Compare Number


# Compare Number Command


## What does this command do?
This command allows you to Compare Number.


## When would I want to use this command?
Use this command when you want to Compare Number.
