...
This command allows you to get arccos.


## When would I want to use this command?
Use this command when you want to get arccos.
...
<dl>
<dt>What to input</dt><dd>Enter or Select the When Value is Out of Range</dd>
<dt>Value</dt><dd>Selection Values (Case Sensitive: No, Whilte-Space Sensitive: Yes)</dd>
...
Automation Class Name: GetArccosCommand
