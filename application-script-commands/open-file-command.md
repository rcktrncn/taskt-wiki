...
Application/Script &gt; File/Folder &gt; Open File
...
This command opens the specified file


## When would I want to use this command?
Use this command to open the specified file
...
<dt>Remarks</dt><dd><strong>Optional</strong><br>Default Value is <strong>2</strong></dd>
</dl>
