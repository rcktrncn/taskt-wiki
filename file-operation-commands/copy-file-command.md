...
File Operation Commands &gt; Copy File
...
This command copies a file to a specified destination


## When would I want to use this command?
Use this command to copy a file to a new destination.
...
- [Optional - Please Select the Variable Name to Store File Path Before Copy](#param_5)
- [Optional - Please Select the Variable Name to Store File Path After Copy](#param_6)
...
<a id="param_5"></a>
### Optional - Please Select the Variable Name to Store File Path Before Copy
...
<a id="param_6"></a>
### Optional - Please Select the Variable Name to Store File Path After Copy
