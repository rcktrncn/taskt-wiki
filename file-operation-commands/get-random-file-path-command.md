<!--TITLE: Get Random File Path Command -->
<!-- SUBTITLE: a command in the File Operation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


File Operation &gt; Get Random File Path


# Get Random File Path Command


## What does this command do?
This command allows you to get random file name path.


## When would I want to use this command?
Use this command when you want to get random file name path.


<a id="param_list"></a>
## Command Parameters
- [[5000,0x00001388] Optional - Please Specify the Folder Path](#param_0)
- [[6300,0x0000189C] Optional - Please Specify the File Extension](#param_1)
- [[6400,0x00001900] Please Select the Variable Name to Store Result](#param_2)
- [[6500,0x00001964] Optional - Please Select the Check File Does Not Exists](#param_3)
...
<a id="param_3"></a>
### [6500,0x00001964] Optional - Please Select the Check File Does Not Exists
...
Automation Class Name: GetRandomFilePathCommand
