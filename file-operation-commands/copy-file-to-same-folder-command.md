<!--TITLE: Copy File To Same Folder Command -->
<!-- SUBTITLE: a command in the File Operation group. -->
[Go To Automation Commands Overview](/automation-commands.md)


File Operation &gt; Copy File To Same Folder


# Copy File To Same Folder Command


## What does this command do?
This command allows to copy a file to same folder.
...
<dt>Sample Usage</dt><dd>newfile or {vNewFileName}</dd>
<dt>Remarks</dt><dd>(nothing)</dd>
</dl>
