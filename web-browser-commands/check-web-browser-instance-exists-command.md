<!--TITLE: Check Web Browser Instance Exists Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Instance &gt; Check Web Browser Instance Exists


# Check Web Browser Instance Exists Command


## What does this command do?
This command returns existance of Web Browser instance.


## When would I want to use this command?
Use this command when you want to check Web Browser Instance existance.
...
Automation Class Name: SeleniumBrowserCheckWebBrowserInstanceExistsCommand
