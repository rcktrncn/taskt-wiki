<!--TITLE: Get Web Browser Position Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Get From Web Browser &gt; Get Web Browser Position


# Get Web Browser Position Command


## What does this command do?
This command allows you to Get Web Browser Position.
...
- [Optional - Please Select the Variable Name to Store X Position](#param_2)
...
<a id="param_1"></a>
### Optional - Please Select the Variable Name to Store X Position
...
Automation Class Name: SeleniumBrowserGetWebBrowserPositionCommand
