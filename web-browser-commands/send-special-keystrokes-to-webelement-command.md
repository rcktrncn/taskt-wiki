<!--TITLE: Send Special Keystrokes To WebElement Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; WebElement Action &gt; Send Special Keystrokes To WebElement


# Send Special Keystrokes To WebElement Command


## What does this command do?
This command allows you to Send Special Keystrokes in WebElement.


## When would I want to use this command?
Use this command when you want to SendSpecial  Keystrokes in WebElement.
