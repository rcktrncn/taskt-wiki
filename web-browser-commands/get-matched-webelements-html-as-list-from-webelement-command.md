<!--TITLE: Get Matched WebElements HTML As List From WebElement Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Search WebElement From WebElement &gt; Get Matched WebElements HTML As List From WebElement


# Get Matched WebElements HTML As List From WebElement Command


## What does this command do?
This command allows you to get Matched WebElements HTML from WebElement.


## When would I want to use this command?
Use this command when you want to get Matched WebElements HTML from WebElement.
...
Automation Class Name: SeleniumBrowserGetMatchedWebElementsHTMLAsListFromWebElementCommand
