<!--TITLE: Get One WebElement Values As Dictionary Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Scraping &gt; Get One WebElement Values As Dictionary


# Get One WebElement Values As Dictionary Command


## What does this command do?
This command allows you to get Attributes value for One WebElement As Dictionary.


## When would I want to use this command?
Use this command when you want to get Attributes value for One WebElement As Dictionary.
...
- [Please Select the Variable Name to Store Dictionary](#param_6)
...
Automation Class Name: SeleniumBrowserGetOneWebElementValuesAsDictionaryCommand
