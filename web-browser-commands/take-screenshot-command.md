...
- [[5000,0x00001388] Please Specify the Folder where the screenshot should be stored](#param_1)
- [[5000,0x00001388] Please Specify the Screenshot File Name (no extension needed)](#param_2)
...
<a id="param_1"></a>
### [5000,0x00001388] Please Specify the Folder where the screenshot should be stored
...
<a id="param_2"></a>
### [5000,0x00001388] Please Specify the Screenshot File Name (no extension needed)
