<!--TITLE: Get WebElement Position Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Get From WebElement &gt; Get WebElement Position


# Get WebElement Position Command


## What does this command do?
This command allows you to Get WebElement Position.


## When would I want to use this command?
Use this command when you want to Get WebElement Position.
...
- [Optional - Please Select the Position Type](#param_4)
...
<a id="param_2"></a>
### Optional - Please Select the Variable Name to Store Y Position
...
<dt>Value</dt><dd>Selection Values (Case Sensitive: No, Whilte-Space Sensitive: Yes)</dd>
<dt>Parameter Direction</dt><dd>The Input Parameter for Executing the command</dd>
<dt>Sample Usage</dt><dd><strong>Screen</strong> or  <strong>Viewport</strong></dd>
<dt>Remarks</dt><dd><strong>Optional</strong><br>Default Value is <strong>Viewport</strong></dd>
</dl>
...
Automation Class Name: SeleniumBrowserGetWebElementPositionCommand
