<!--TITLE: Get Window And Tab URLs As Dictionary Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Window/Tab &gt; Get Window And Tab URLs As Dictionary


# Get Window And Tab URLs As Dictionary Command


## What does this command do?
This command allows you to Get Page URLs of Windows and Tabs As Dictionary.


## When would I want to use this command?
Use this command when you want to Get Page URLs of Windows and Tabs As Dictionary.


<a id="param_list"></a>
## Command Parameters
- [[5000,0x00001388] Please Select the WebBrowser Instance Name](#param_0)
- [[5000,0x00001388] Please Select the Variable Name to Store Dictionary](#param_1)
...
Automation Class Name: SeleniumBrowserGetWindowAndTabURLsAsDictionaryCommand
