<!--TITLE: Execute JavaScript From File Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Web Browser Actions &gt; Execute JavaScript From File


# Execute JavaScript From File Command


## What does this command do?
This command allows you to execute a JavaScript from File.
...
<a id="param_1"></a>
### Please Specify the JavaScript File
...
<dt>Sample Usage</dt><dd>c:\js\mycode.js or {vFile} or C:\temp\myfile.txt or {vFilePath}</dd>
...
| <strong>{vFile}</strong> | Specify the Variable Value **vCode** for JavaScript Code or JavaScript File Path |
...
| Value | Means |
|---|---|
| <strong>0</strong> | Specify **0** for Arguments |
| <strong>{vValue}</strong> | Specify Value of Variable **vValue** for Arguments |
