...
- [[5000,0x00001388] Optional - Please Select the When the WebElement does not support Clear Text](#param_1)
...
<a id="param_1"></a>
### [5000,0x00001388] Optional - Please Select the When the WebElement does not support Clear Text
