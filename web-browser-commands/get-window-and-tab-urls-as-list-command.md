<!--TITLE: Get Window And Tab URLs As List Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Window/Tab &gt; Get Window And Tab URLs As List


# Get Window And Tab URLs As List Command


## What does this command do?
This command allows you to Get Page URLs of Windows and Tabs As List.


## When would I want to use this command?
Use this command when you want to Get Page URLs of Windows and Tabs As List.
...
Automation Class Name: SeleniumBrowserGetWindowAndTabURLsAsListCommand
