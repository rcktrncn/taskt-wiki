<!--TITLE: Get One WebElement Values As DataTable Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Scraping &gt; Get One WebElement Values As DataTable


# Get One WebElement Values As DataTable Command


## What does this command do?
This command allows you to get Attributes value for One WebElement As DataTable.


## When would I want to use this command?
Use this command when you want to get Attributes value for One WebElement As DataTable.
...
Automation Class Name: SeleniumBrowserGetOneWebElementValuesAsDataTableCommand
