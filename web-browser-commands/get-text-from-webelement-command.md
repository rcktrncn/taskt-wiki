<!--TITLE: Get Text From WebElement Command -->
<!-- SUBTITLE: a command in the Web Browser Commands group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser Commands &gt; Get From WebElement &gt; Get Text From WebElement


# Get Text From WebElement Command


## What does this command do?
This command allows you to Get Text Value from WebElement.


## When would I want to use this command?
Use this command when you want to Get Text Value from WebElement.
