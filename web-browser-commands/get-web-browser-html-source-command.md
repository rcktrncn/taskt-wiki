<!--TITLE: Get Web Browser HTML Source Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Get From Web Browser &gt; Get Web Browser HTML Source


# Get Web Browser HTML Source Command


## What does this command do?
This command allows you to Get HTML Source from Web Browser.


## When would I want to use this command?
Use this command when you want to Get HTML Source from Web Browser.
...
Automation Class Name: SeleniumBrowserGetWebBrowserHTMLSourceCommand
