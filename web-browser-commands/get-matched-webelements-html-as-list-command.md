<!--TITLE: Get Matched WebElements HTML As List Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Search WebElement &gt; Get Matched WebElements HTML As List


# Get Matched WebElements HTML As List Command
...
Automation Class Name: SeleniumBrowserGetMatchedWebElementsHTMLAsListCommand
