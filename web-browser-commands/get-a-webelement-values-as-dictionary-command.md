<!--TITLE: Get A WebElement Values As Dictionary Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Scraping &gt; Get A WebElement Values As Dictionary


# Get A WebElement Values As Dictionary Command


## What does this command do?
This command allows you to get Attributes value for a WebElement As Dictionary.


## When would I want to use this command?
Use this command when you want to get Attributes value for a WebElement As Dictionary.
...
- [[5000,0x00001388] Please Select the Variable Name to Store Dictionary](#param_5)
...
<a id="param_5"></a>
### [5000,0x00001388] Please Select the Variable Name to Store Dictionary
...
Automation Class Name: SeleniumBrowserGetAWebElementValuesAsDictionaryCommand
