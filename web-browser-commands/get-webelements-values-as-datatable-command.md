<!--TITLE: Get WebElements Values As DataTable Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Scraping &gt; Get WebElements Values As DataTable


# Get WebElements Values As DataTable Command


## What does this command do?
This command allows you to get Attributes value for WegElements As DataTable.


## When would I want to use this command?
Use this command when you want to get Attributes value for WegElements As DataTable.
...
- [[5000,0x00001388] Please Specify the Attributes Name to Get](#param_3)
- [[5000,0x00001388] Please Select the Variable Name to Store DataTable](#param_4)
