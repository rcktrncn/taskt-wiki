<!--TITLE: Wait For WebElement To Exists From WebElement Command -->
...
This command allows you to Wait for WebElement exists from WebElement.


## When would I want to use this command?
Use this command when you want to Wait for WebElement exists from WebElement.
