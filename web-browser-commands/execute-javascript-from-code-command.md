<!--TITLE: Execute JavaScript From Code Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Web Browser Actions &gt; Execute JavaScript From Code


# Execute JavaScript From Code Command
...
- [Please Specify the JavaScript Code](#param_1)
...
<dt>Sample Usage</dt><dd>return (2); or {vCode}</dd>
...
Automation Class Name: SeleniumBrowserExecuteJavaScriptFromCodeCommand
