<!--TITLE: Get Table Values As DataTable Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Scraping &gt; Get Table Values As DataTable


# Get Table Values As DataTable Command
...
<a id="param_3"></a>
### Optional - Please Specify the Attribute Name
