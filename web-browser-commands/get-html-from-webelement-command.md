<!--TITLE: Get HTML From WebElement Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Get From WebElement &gt; Get HTML From WebElement
...
This command allows you to Get HTML from WebElement.


## When would I want to use this command?
Use this command when you want to Get HTML from WebElement.
