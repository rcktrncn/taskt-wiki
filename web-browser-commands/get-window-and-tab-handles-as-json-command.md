<!--TITLE: Get Window And Tab Handles As JSON Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Window/Tab &gt; Get Window And Tab Handles As JSON


# Get Window And Tab Handles As JSON Command


## What does this command do?
This command allows you to Get Web Browser Handles of Windows and Tabs.


## When would I want to use this command?
Use this command when you want to Get Web Browser Handles of Windows and Tabs.
...
Automation Class Name: SeleniumBrowserGetWindowAndTabHandlesAsJSONCommand
