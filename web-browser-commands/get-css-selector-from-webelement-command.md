<!--TITLE: Get CSS Selector From WebElement Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Get From WebElement &gt; Get CSS Selector From WebElement


# Get CSS Selector From WebElement Command


## What does this command do?
This command allows you to Get CSS Selector from WebElement.


## When would I want to use this command?
Use this command when you want to Get CSS Selector from WebElement.
...
- [Optional - Please Select the Believe ID Attribute](#param_2)
...
<a id="param_2"></a>
### Optional - Please Select the Believe ID Attribute
...
Automation Class Name: SeleniumBrowserGetCSSSelectorFromWebElementCommand
