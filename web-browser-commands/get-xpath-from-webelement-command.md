<!--TITLE: Get XPath From WebElement Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Get From WebElement &gt; Get XPath From WebElement


# Get XPath From WebElement Command


## What does this command do?
This command allows you to Get XPath from WebElement.


## When would I want to use this command?
Use this command when you want to Get XPath from WebElement.
...
Automation Class Name: SeleniumBrowserGetXPathFromWebElementCommand
