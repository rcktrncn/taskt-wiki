<!--TITLE: Search Shadow DOM WebElement From WebElement Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; Search WebElement From WebElement &gt; Search Shadow DOM WebElement From WebElement


# Search Shadow DOM WebElement From WebElement Command


## What does this command do?
This command allows you to search Shadow DOM WebElement from WebElement.


## When would I want to use this command?
Use this command when you want to get Shadow DOM WebElement from WebElement.
...
- [Please Select the Variable Name to Store WebElement](#param_5)
...
<dt>Sample Usage</dt><dd><strong>Find Elements By CSS Selector</strong> or  <strong>Find Element By CSS Selector</strong></dd>
...
Automation Class Name: SeleniumBrowserSearchShadowDOMWebElementFromWebElementCommand
