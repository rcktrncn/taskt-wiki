<!--TITLE: Remove WebElement Command -->
<!-- SUBTITLE: a command in the Web Browser group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser &gt; WebElement Action &gt; Remove WebElement


# Remove WebElement Command


## What does this command do?
This command allows you to Remove WebElement.


## When would I want to use this command?
Use this command when you want to Remove WebElement.
...
Automation Class Name: SeleniumBrowserRemoveWebElementCommand
